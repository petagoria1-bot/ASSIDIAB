...
const fr = {
  ...
  auth_googleSignIn: "Continuer avec Google",
  ...
  auth_signupButton: "Créer le compte",
  auth_or: "OU",
  auth_noAccount: "Pas encore de compte ?",
  auth_hasAccount: "Déjà un compte ?",
  auth_signupNow: "Inscrivez-vous",
  auth_loginNow: "Connectez-vous",
  ...
  invitation_createAccount_prompt: "Pour accepter, veuillez créer votre compte ou vous connecter.",
  ...
  settings_family_pending_invitation: "Invitation envoyée",
  ...
  invite_button: "Générer le lien",
  shareInvite_title: "Invitation prête !",
  shareInvite_description: "Partagez ce lien unique avec la personne que vous invitez. Il est à usage unique et expire dans 72 heures.",
